        ...
        <div style="padding:20px;margin-top:50px;">
            <table>
                ...
                <form action="UpdateNote" method="POST">
                    ...
                    <td><input type="number" min="0" max="20" step="0.01" name="sn" value="<%=sn == null ? "vide" : sn.doubleValue()%>"/></td>
                    <td><input type="number" min="0" max="20" step="0.01" name="sr" value="<%=sr == null ? "vide" : sr.doubleValue()%>"/></td>
                    <td>
