...
<html>
    ...
    <body>
            ...
            <table>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><form action="/MasterM2I/Admin/InscriptionEtudiant" method="POST">
                                <button class="button info active" type="submit" name="cne" value="<%=etudiant.getCne()%>">Inscription</button>
                            </form>
                        </td>
                    </tr>
                    <%
        ...
        <%
            request.setAttribute("active", "Inscription");
        %>
